function S = horizontalSeamCollective( I1, I2 )
...
restriction = rows*0.1; %only search pixels in middle 20% of image
...
for c=2:cols
    for r=2:rows+1
        ...
        cumenergies(r,c) = I1(r,c) + I2(r,c) + minenergy;
